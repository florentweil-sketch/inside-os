# PROMPT MAÎTRE V5 — TRANSFERT DE THREAD
...
|----------|------|--------------|
| README vXX | Référence architecture | Décision majeure ou changement stratégique |
...
**Règle absolue : les trois numéros sont indépendants. README v05 + PROMPT v05 + CONTEXT v11 = configuration valide.**
