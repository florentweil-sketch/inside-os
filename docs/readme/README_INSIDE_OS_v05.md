...
Les trois numéros sont indépendants. README v05 + PROMPT v04 + CONTEXT v10 = configuration valide.
...
os/
  ...
  chat/           → notion-memory-server.mjs (prod) / notion-memory-chat.mjs (test)
...
data/
  threads_to_process/   → threads à ingérer
...
- Remote Git à configurer (backup externe obligatoire)
