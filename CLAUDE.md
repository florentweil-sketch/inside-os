...
- **Numérotation des threads.** Un thread B09-Txx = une conversation architecte-conseil complète. Les sessions Claude Code héritent de l'id du thread en cours (fourni par Florent en début de session), jamais de numéro propre. B09-T42 est un id brûlé (dérive d'étiquetage août 2026), non réutilisé.
