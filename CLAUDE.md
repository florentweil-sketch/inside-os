...
- **Fin de session : écrire le récap complet dans `recap-session.md` à la racine** (écrasement, jamais d'historique — git le trace) — c'est le canal de transfert vers l'architecte-conseil, pas un document système.
