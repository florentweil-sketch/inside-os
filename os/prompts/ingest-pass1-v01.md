# INGEST — PASSE 1 — v01
## Résumé dense + extraction décisions + lessons
...
{
  "summary": {
    "short": "2-3 phrases maximum — l'essentiel du thread pour le chat et les agents",
  ...
  "decisions": [
    {
      ...
      "agent_suggestions": [
        {
          "name": "Nom de l'agent suggéré",
          "rationale": "pourquoi cet agent manque dans la liste actuelle",
          "type": "new | sub-agent",
          "parent": "Nom de l'agent parent si sub-agent (null sinon)"
        }
      ]
    }
  ],
...
- Le `summary.full` couvre-t-il tous les sujets majeurs du thread ?
